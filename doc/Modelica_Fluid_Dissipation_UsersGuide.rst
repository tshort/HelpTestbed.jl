...
|Modelica.Fluid.Dissipation.UsersGuide| `Modelica.Fluid.Dissipation <Modelica_Fluid_Dissipation.html#Modelica.Fluid.Dissipation>`_.UsersGuide
---------------------------------------------------------------------------------------------------------------------------------------------
...
| Name                                                                                                                                                                         | Description       |
+==============================================================================================================================================================================+===================+
| |image4| `GettingStarted <Modelica_Fluid_Dissipation_UsersGuide.html#Modelica.Fluid.Dissipation.UsersGuide.GettingStarted>`_                                                 | Getting Started   |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------+
| |image5| `ReleaseNotes <Modelica_Fluid_Dissipation_UsersGuide.html#Modelica.Fluid.Dissipation.UsersGuide.ReleaseNotes>`_                                                     | Release notes     |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------+
| |image6| `Contact <Modelica_Fluid_Dissipation_UsersGuide.html#Modelica.Fluid.Dissipation.UsersGuide.Contact>`_                                                               | Contact           |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------+

--------------

|image7| `Modelica.Fluid.Dissipation.UsersGuide <Modelica_Fluid_Dissipation_UsersGuide.html#Modelica.Fluid.Dissipation.UsersGuide>`_.GettingStarted
---------------------------------------------------------------------------------------------------------------------------------------------------
...
package
Fittings) <Modelica_Fluid_Fittings.html#Modelica.Fluid.Fittings>`_.
 In the following the implementation method is described in 5 steps for
a straight pipe as example. Generally the implementation method can be
...
devices <Modelica_Fluid_Fittings.html#Modelica.Fluid.Fittings>`_.
...
|image8| `Modelica.Fluid.Dissipation.UsersGuide <Modelica_Fluid_Dissipation_UsersGuide.html#Modelica.Fluid.Dissipation.UsersGuide>`_.ReleaseNotes
-------------------------------------------------------------------------------------------------------------------------------------------------
...
-  Changed structure for input records of all heat transfer and pressure
   loss functions:

   -  Reduced amount of input records for compressible and
      incompressible functions as well as for their combinational one to
      improve usability of library.
...
-  Changed flow models structure:
    Now that a future feature for the automatic choice of using either a
   mass flow rate (compressible case) or a pressure loss (incompressible
   case) function for calculation is supported if implemented by IDE.
   Due to that no manual selection of a compressible or incompressible
   calculation in the Modelica.Fluid flow models is possible anymore.
   Therefore nonlinear equations will be created from the Modelica.Fluid
   flow models, if the future feature is not supported and the mass flow
   rate is known at a fluid port instead of the pressure loss.
...
|image9| `Modelica.Fluid.Dissipation.UsersGuide <Modelica_Fluid_Dissipation_UsersGuide.html#Modelica.Fluid.Dissipation.UsersGuide>`_.Contact
--------------------------------------------------------------------------------------------------------------------------------------------
...
Stefan Wischhusen
 ...
 Hamburg, Germany
 email:
`wischhusen@xrg-simulation.de <mailto:wischhusen@xrg-simulation.de>`_
...
.. |Modelica.Fluid.Dissipation.UsersGuide| image:: Modelica.Fluid.Dissipation.UsersGuideI.png
.. |Modelica.Fluid.Dissipation.UsersGuide.GettingStarted| image:: Modelica.Fluid.Dissipation.UsersGuide.GettingStartedS.png
.. |Modelica.Fluid.Dissipation.UsersGuide.ReleaseNotes| image:: Modelica.Fluid.Dissipation.UsersGuide.ReleaseNotesS.png
.. |Modelica.Fluid.Dissipation.UsersGuide.Contact| image:: Modelica.Fluid.Dissipation.UsersGuide.ContactS.png
.. |image4| image:: Modelica.Fluid.Dissipation.UsersGuide.GettingStartedS.png
.. |image5| image:: Modelica.Fluid.Dissipation.UsersGuide.ReleaseNotesS.png
.. |image6| image:: Modelica.Fluid.Dissipation.UsersGuide.ContactS.png
.. |image7| image:: Modelica.Fluid.Dissipation.UsersGuideI.png
.. |image8| image:: Modelica.Fluid.Dissipation.UsersGuide.ReleaseNotesI.png
.. |image9| image:: Modelica.Fluid.Dissipation.UsersGuide.ContactI.png
