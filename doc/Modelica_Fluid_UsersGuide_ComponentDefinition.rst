...
|Modelica.Fluid.UsersGuide.ComponentDefinition| `Modelica.Fluid.UsersGuide <Modelica_Fluid_UsersGuide.html#Modelica.Fluid.UsersGuide>`_.ComponentDefinition
-----------------------------------------------------------------------------------------------------------------------------------------------------------
...
This section is partly based on the following paper:
 ...
 Elmqvist H., Tummescheit H., and Otter M.:
    **Object-Oriented Modeling of Thermo-Fluid Systems**. Modelica 2003
    Conference, Linköping, Sweden, pp. 269-286, Nov. 3-4, 2003. Download
    from:
    `http://www.modelica.org/Conference2003/papers/h40\_Elmqvist\_fluid.pdf <http://www.modelica.org/Conference2003/papers/h40_Elmqvist_fluid.pdf>`_
...
| Name                                                                                                                                                                                                                                        | Description                    |
+=============================================================================================================================================================================================================================================+================================+
| |image7| `FluidConnectors <Modelica_Fluid_UsersGuide_ComponentDefinition.html#Modelica.Fluid.UsersGuide.ComponentDefinition.FluidConnectors>`_                                                                                              | Fluid connectors               |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------+
| |image8| `BalanceEquations <Modelica_Fluid_UsersGuide_ComponentDefinition.html#Modelica.Fluid.UsersGuide.ComponentDefinition.BalanceEquations>`_                                                                                            | Balance equations              |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------+
| |image9| `UpstreamDiscretization <Modelica_Fluid_UsersGuide_ComponentDefinition.html#Modelica.Fluid.UsersGuide.ComponentDefinition.UpstreamDiscretization>`_                                                                                | Upstream discretization        |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------+
| |image10| `RegularizingCharacteristics <Modelica_Fluid_UsersGuide_ComponentDefinition.html#Modelica.Fluid.UsersGuide.ComponentDefinition.RegularizingCharacteristics>`_                                                                     | Regularizing characteristics   |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------+
| |image11| `WallFriction <Modelica_Fluid_UsersGuide_ComponentDefinition.html#Modelica.Fluid.UsersGuide.ComponentDefinition.WallFriction>`_                                                                                                   | Wall friction                  |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------+
| |image12| `ValveCharacteristics <Modelica_Fluid_UsersGuide_ComponentDefinition.html#Modelica.Fluid.UsersGuide.ComponentDefinition.ValveCharacteristics>`_                                                                                   | Valve characteristics          |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------+

--------------

|image13| `Modelica.Fluid.UsersGuide.ComponentDefinition <Modelica_Fluid_UsersGuide_ComponentDefinition.html#Modelica.Fluid.UsersGuide.ComponentDefinition>`_.FluidConnectors
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
.. figure:: ../Resources/Images/Fluid/UsersGuide/MixingConnections.png
   :align: center
   :alt: 
...
CO\ :sub:`2`\  traces to Moist Air for air conditioning models).
...
-  the momentum and energy balance are only exact when two port with the
   same diameter are connected, because there is no friction and no
...
-  There might thus be errors in the momentum balance of the order of
   magnitude of the dynamic pressure ρv\ :sup:`2`\ /2.
-  The energy balance does not consider the kinetic terms (gravity terms
   cancel out due to the infinitesimal size of the connection volume).
   There might thus be errors in the momentum balance of the order of
   magnitude of the kinetic energy v^2/2.
...
|image14| `Modelica.Fluid.UsersGuide.ComponentDefinition <Modelica_Fluid_UsersGuide_ComponentDefinition.html#Modelica.Fluid.UsersGuide.ComponentDefinition>`_.BalanceEquations
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
.. figure:: ../Resources/Images/Fluid/UsersGuide/massBalance.png
   :align: center
   :alt: 

Momentum balance

.. figure:: ../Resources/Images/Fluid/UsersGuide/momentumBalance.png
   :align: center
   :alt: 

Energy balance 1

.. figure:: ../Resources/Images/Fluid/UsersGuide/energyBalance1.png
   :align: center
   :alt: 

Pipe friction

.. figure:: ../Resources/Images/Fluid/UsersGuide/pipeFriction.png
   :align: center
   :alt: 
...
|image17| `Modelica.Fluid.UsersGuide.ComponentDefinition <Modelica_Fluid_UsersGuide_ComponentDefinition.html#Modelica.Fluid.UsersGuide.ComponentDefinition>`_.UpstreamDiscretization
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
|image18| `Modelica.Fluid.UsersGuide.ComponentDefinition <Modelica_Fluid_UsersGuide_ComponentDefinition.html#Modelica.Fluid.UsersGuide.ComponentDefinition>`_.RegularizingCharacteristics
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
.. figure:: ../Resources/Images/Fluid/UsersGuide/sqrt.png
   :align: center
   :alt: 
...
|image19| `Modelica.Fluid.UsersGuide.ComponentDefinition <Modelica_Fluid_UsersGuide_ComponentDefinition.html#Modelica.Fluid.UsersGuide.ComponentDefinition>`_.WallFriction
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
(see
`Pipes.BaseClasses.WallFriction <Modelica_Fluid_Pipes_BaseClasses_WallFriction.html#Modelica.Fluid.Pipes.BaseClasses.WallFriction>`_.
...
coefficient λ2 = λ\*Re^2, because λ2 = 64\*Re if Re < 2000 and therefore
no problems for zero mass flow rate occur. The characteristic of λ2 is
shown in the next figure and is used in Modelica.Fluid:

.. figure:: ../Resources/Images/Fluid/Components/PipeFriction2.png
   :align: center
   :alt: PipeFriction2
...
-  **Region 3**: For **Re ≥ 4000**, the flow is **turbulent**. Depending
   on the calculation direction (see "inverse formulation" below) either
   of two explicite equations are used. If the pressure drop dp is
   assumed to be known, λ2 = \|dp\|/k2. The Colebrook-White equation
   *[Colebrook 1939; Idelchik 1994, p. 83, eq. (2-9)]*:
   ...
   Re\*π\*D\*μ/4\*sign(dp). These are the **red** curves in the diagrams
   above.
    If the mass flow rate is assumed known (and therefore implicitly
   also the Reynolds number), then λ2 is computed by an approximation of
   the inverse of the Colebrook-White equation *[Swamee and Jain 1976;
...
-  **Region 2**: For **2000 ≤ Re ≤ 4000** there is a transition region
   ...
   therefore only crude approximations are possible in this area.
   ...
   *[Samoilenko 1968; Idelchik 1994, p. 81, sect. 2.1.21]* as:
   ...
   that the first derivative is continuous at these two points. In order
   to avoid the solution of non-linear equations, two different cubic
   polynomials are used for the direct and the inverse formulation. This
   leads to some discrepancies in λ2 (= differences between the red and
   the blue curves). This is acceptable, because the transition region
   is anyway not precisely known since the actual friction coefficient
   depends on additional factors and since the operating points are
...
|image20| `Modelica.Fluid.UsersGuide.ComponentDefinition <Modelica_Fluid_UsersGuide_ComponentDefinition.html#Modelica.Fluid.UsersGuide.ComponentDefinition>`_.ValveCharacteristics
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

::

The control valves in
`Modelica.Fluid.Valves <Modelica_Fluid_Valves.html#Modelica.Fluid.Valves>`_
...
.. |Modelica.Fluid.UsersGuide.ComponentDefinition| image:: Modelica.Fluid.UsersGuide.ComponentDefinitionI.png
.. |Modelica.Fluid.UsersGuide.ComponentDefinition.FluidConnectors| image:: Modelica.Fluid.UsersGuide.ComponentDefinition.FluidConnectorsS.png
.. |Modelica.Fluid.UsersGuide.ComponentDefinition.BalanceEquations| image:: Modelica.Fluid.UsersGuide.ComponentDefinition.FluidConnectorsS.png
.. |Modelica.Fluid.UsersGuide.ComponentDefinition.UpstreamDiscretization| image:: Modelica.Fluid.UsersGuide.ComponentDefinition.FluidConnectorsS.png
.. |Modelica.Fluid.UsersGuide.ComponentDefinition.RegularizingCharacteristics| image:: Modelica.Fluid.UsersGuide.ComponentDefinition.FluidConnectorsS.png
.. |Modelica.Fluid.UsersGuide.ComponentDefinition.WallFriction| image:: Modelica.Fluid.UsersGuide.ComponentDefinition.FluidConnectorsS.png
.. |Modelica.Fluid.UsersGuide.ComponentDefinition.ValveCharacteristics| image:: Modelica.Fluid.UsersGuide.ComponentDefinition.FluidConnectorsS.png
.. |image7| image:: Modelica.Fluid.UsersGuide.ComponentDefinition.FluidConnectorsS.png
.. |image8| image:: Modelica.Fluid.UsersGuide.ComponentDefinition.FluidConnectorsS.png
.. |image9| image:: Modelica.Fluid.UsersGuide.ComponentDefinition.FluidConnectorsS.png
.. |image10| image:: Modelica.Fluid.UsersGuide.ComponentDefinition.FluidConnectorsS.png
.. |image11| image:: Modelica.Fluid.UsersGuide.ComponentDefinition.FluidConnectorsS.png
.. |image12| image:: Modelica.Fluid.UsersGuide.ComponentDefinition.FluidConnectorsS.png
.. |image13| image:: Modelica.Fluid.UsersGuide.ComponentDefinitionI.png
.. |image14| image:: Modelica.Fluid.UsersGuide.ComponentDefinitionI.png
.. |image15| image:: ../Resources/Images/Fluid/UsersGuide/energyBalance2.png
.. |image16| image:: ../Resources/Images/Fluid/UsersGuide/energyBalance2.png
.. |image17| image:: Modelica.Fluid.UsersGuide.ComponentDefinitionI.png
.. |image18| image:: Modelica.Fluid.UsersGuide.ComponentDefinitionI.png
.. |image19| image:: Modelica.Fluid.UsersGuide.ComponentDefinitionI.png
.. |image20| image:: Modelica.Fluid.UsersGuide.ComponentDefinitionI.png
