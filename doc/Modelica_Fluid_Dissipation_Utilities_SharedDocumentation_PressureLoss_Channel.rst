...
|Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.PressureLoss.Channel| `Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.PressureLoss <Modelica_Fluid_Dissipation_Utilities_SharedDocumentation_PressureLoss.html#Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.PressureLoss>`_.Channel
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
| Name                                                                                                                                                                                                                                                                                                                           | Description   |
+================================================================================================================================================================================================================================================================================================================================+===============+
| |image2| `dp\_internalFlowOverall <Modelica_Fluid_Dissipation_Utilities_SharedDocumentation_PressureLoss_Channel.html#Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.PressureLoss.Channel.dp_internalFlowOverall>`_                                                                                                  |               |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------+

--------------

|image3| `Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.PressureLoss.Channel <Modelica_Fluid_Dissipation_Utilities_SharedDocumentation_PressureLoss_Channel.html#Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.PressureLoss.Channel>`_.dp\_internalFlowOverall
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
.. figure:: ../Resources/Images/Fluid/Dissipation/pressureLoss/channel/pic-pLchannel.png
   :align: center
   :alt: pic-pLchannel
...
-  **Turbulent regime (Re ≥ 4e3)**:
   ...
   `dp\_turbulent <Modelica_Fluid_Dissipation_Utilities_SharedDocumentation_PressureLoss_StraightPipe.html#Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.PressureLoss.StraightPipe.dp_turbulent>`_.

with

+-----------------+-------------------------------------------------------------------------+
| **CF\_lam**     | as correction factor considering the geometry for laminar regime [-],   |
+-----------------+-------------------------------------------------------------------------+
...
.. figure:: ../Resources/Images/Fluid/Dissipation/pressureLoss/channel/fig_channel_dp_internalFlowOverall_lambdaVsRe.png
   :align: center
   :alt: fig\_channel\_dp\_internalFlowOverall\_lambdaVsRe

   fig\_channel\_dp\_internalFlowOverall\_lambdaVsRe
...
.. |Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.PressureLoss.Channel| image:: Modelica.Fluid.Dissipation.Utilities.SharedDocumentationI.png
.. |Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.PressureLoss.Channel.dp\_internalFlowOverall| image:: Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.HeatTransferS.png
