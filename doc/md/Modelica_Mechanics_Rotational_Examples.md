...
[Modelica.Mechanics.Rotational](Modelica_Mechanics_Rotational.html#Modelica.Mechanics.Rotational).Examples
==========================================================================================================
...
---------------
  ...
  Name                                                Description
  --------------------------------------------------- --------------------
  ![image12](Modelica.Mechanics.Rotational.Examples.F First example:
  irstS.png)                                          simple drive train
  [First](Modelica_Mechanics_Rotational_Examples.html 
  #Modelica.Mechanics.Rotational.Examples.First)      

  ![image13](Modelica.Mechanics.Rotational.Examples.F First example:
  irstS.png)                                          simple drive train
  [FirstGrounded](Modelica_Mechanics_Rotational_Examp with grounded
  les.html#Modelica.Mechanics.Rotational.Examples.Fir elments
  stGrounded)                                         

  ![image14](Modelica.Mechanics.Rotational.Examples.F Drive train with
  irstS.png)                                          clutch and brake
  [Friction](Modelica_Mechanics_Rotational_Examples.h 
  tml#Modelica.Mechanics.Rotational.Examples.Friction 
  )                                                   

  ![image15](Modelica.Mechanics.Rotational.Examples.F Drive train with 3
  irstS.png)                                          dynamically coupled
  [CoupledClutches](Modelica_Mechanics_Rotational_Exa clutches
  mples.html#Modelica.Mechanics.Rotational.Examples.C 
  oupledClutches)                                     

  ![image16](Modelica.Mechanics.Rotational.Examples.F Example to show that
  irstS.png)                                          gear efficiency may
  [LossyGearDemo1](Modelica_Mechanics_Rotational_Exam lead to stuck motion
  ples.html#Modelica.Mechanics.Rotational.Examples.Lo 
  ssyGearDemo1)                                       

  ![image17](Modelica.Mechanics.Rotational.Examples.F Example to show
  irstS.png)                                          combination of
  [LossyGearDemo2](Modelica_Mechanics_Rotational_Exam LossyGear and
  ples.html#Modelica.Mechanics.Rotational.Examples.Lo BearingFriction
  ssyGearDemo2)                                       

  ![image18](Modelica.Mechanics.Rotational.Examples.F Example that failed
  irstS.png)                                          in the previous
  [LossyGearDemo3](Modelica_Mechanics_Rotational_Exam version of the
  ples.html#Modelica.Mechanics.Rotational.Examples.Lo LossyGear version
  ssyGearDemo3)                                       

  ![image19](Modelica.Mechanics.Rotational.Examples.F Example to show
  irstS.png)                                          possible usage of
  [ElasticBearing](Modelica_Mechanics_Rotational_Exam support flange
  ples.html#Modelica.Mechanics.Rotational.Examples.El 
  asticBearing)                                       

  ![image20](Modelica.Mechanics.Rotational.Examples.F Example to
  irstS.png)                                          demonstrate backlash
  [Backlash](Modelica_Mechanics_Rotational_Examples.h 
  tml#Modelica.Mechanics.Rotational.Examples.Backlash 
  )                                                   

  ![image21](Modelica.Mechanics.Rotational.Examples.F Demonstrate coupling
  irstS.png)                                          Rotational -
  [RollingWheel](Modelica_Mechanics_Rotational_Exampl Translational
  es.html#Modelica.Mechanics.Rotational.Examples.Roll 
  ingWheel)                                           

  ![image22](Modelica.Mechanics.Rotational.Examples.F Demonstrate the
  irstS.png)                                          modeling of heat
  [HeatLosses](Modelica_Mechanics_Rotational_Examples losses
  .html#Modelica.Mechanics.Rotational.Examples.HeatLo 
  sses)                                               

  ![image23](Modelica.Mechanics.Rotational.Examples.F Simple Gearshift
  irstS.png)                                          
  [SimpleGearShift](Modelica_Mechanics_Rotational_Exa 
  mples.html#Modelica.Mechanics.Rotational.Examples.S 
  impleGearShift)                                     
  ------------------------------------------------------------------------

* * * * *

![image24](Modelica.Mechanics.Rotational.Examples.FirstI.png) [Modelica.Mechanics.Rotational.Examples](Modelica_Mechanics_Rotational_Examples.html#Modelica.Mechanics.Rotational.Examples).First
================================================================================================================================================================================================
...
Simulate for 1 second and plot the following variables:
  ~ angular velocities of inertias inertia2 and 3: inertia2.w,
    inertia3.w
...
----------
  ...
  Type                                  Name    Defaul Description
                                                t      
  ------------------------------------- ------- ------ --------------------
  [Torque](Modelica_SIunits.html#Modeli amplitu 10     Amplitude of driving
  ca.SIunits.Torque)                    de             torque [N.m]

  [Frequency](Modelica_SIunits.html#Mod freqHz  5      Frequency of driving
  elica.SIunits.Frequency)                             torque [Hz]

  [Inertia](Modelica_SIunits.html#Model Jmotor  0.1    Motor inertia
  ica.SIunits.Inertia)                                 [kg.m2]

  [Inertia](Modelica_SIunits.html#Model Jload   2      Load inertia [kg.m2]
  ica.SIunits.Inertia)                                 

  Real                                  ratio   10     Gear ratio

  Real                                  damping 10     Damping in bearing
                                                       of gear
  -------------------------------------------------------------------------
...
![image25](Modelica.Mechanics.Rotational.Examples.FirstI.png) [Modelica.Mechanics.Rotational.Examples](Modelica_Mechanics_Rotational_Examples.html#Modelica.Mechanics.Rotational.Examples).FirstGrounded
========================================================================================================================================================================================================
...
![image26](Modelica.Mechanics.Rotational.Examples.FirstI.png) [Modelica.Mechanics.Rotational.Examples](Modelica_Mechanics_Rotational_Examples.html#Modelica.Mechanics.Rotational.Examples).Friction
===================================================================================================================================================================================================
...
----------
  ...
  ------------------------------------- --------- ------- -----------------
  [Time](Modelica_SIunits.html#Modelica startTime 0.5     Start time of
  .SIunits.Time)                                          step [s]
  -------------------------------------------------------------------------
...
![image27](Modelica.Mechanics.Rotational.Examples.FirstI.png) [Modelica.Mechanics.Rotational.Examples](Modelica_Mechanics_Rotational_Examples.html#Modelica.Mechanics.Rotational.Examples).CoupledClutches
==========================================================================================================================================================================================================
...
different configurations and 3\^3 = 27 different states (every clutch
may be in forward sliding, backward sliding or locked mode when the
relative angular velocity is zero). By invoking the clutches at
different time instances, the switching of the configurations can be
studied.
...
----------
  ...
  Type                              Name  Defau Description
                                          lt    
  --------------------------------- ----- ----- --------------------------
  [Frequency](Modelica_SIunits.html freqH 0.2   Frequency of sine function
  #Modelica.SIunits.Frequency)      z           to invoke clutch1 [Hz]

  [Time](Modelica_SIunits.html#Mode T2    0.4   Time when clutch2 is
  lica.SIunits.Time)                            invoked [s]

  [Time](Modelica_SIunits.html#Mode T3    0.9   Time when clutch3 is
  lica.SIunits.Time)                            invoked [s]
  ------------------------------------------------------------------------
...
![image28](Modelica.Mechanics.Rotational.Examples.FirstI.png) [Modelica.Mechanics.Rotational.Examples](Modelica_Mechanics_Rotational_Examples.html#Modelica.Mechanics.Rotational.Examples).LossyGearDemo1
=========================================================================================================================================================================================================
...
![image29](Modelica.Mechanics.Rotational.Examples.FirstI.png) [Modelica.Mechanics.Rotational.Examples](Modelica_Mechanics_Rotational_Examples.html#Modelica.Mechanics.Rotational.Examples).LossyGearDemo2
=========================================================================================================================================================================================================
...
![image30](Modelica.Mechanics.Rotational.Examples.FirstI.png) [Modelica.Mechanics.Rotational.Examples](Modelica_Mechanics_Rotational_Examples.html#Modelica.Mechanics.Rotational.Examples).LossyGearDemo3
=========================================================================================================================================================================================================
...
![image31](Modelica.Mechanics.Rotational.Examples.FirstI.png) [Modelica.Mechanics.Rotational.Examples](Modelica_Mechanics_Rotational_Examples.html#Modelica.Mechanics.Rotational.Examples).ElasticBearing
=========================================================================================================================================================================================================
...
![image32](Modelica.Mechanics.Rotational.Examples.FirstI.png) [Modelica.Mechanics.Rotational.Examples](Modelica_Mechanics_Rotational_Examples.html#Modelica.Mechanics.Rotational.Examples).Backlash
===================================================================================================================================================================================================
...
![image33](Modelica.Mechanics.Rotational.Examples.FirstI.png) [Modelica.Mechanics.Rotational.Examples](Modelica_Mechanics_Rotational_Examples.html#Modelica.Mechanics.Rotational.Examples).RollingWheel
=======================================================================================================================================================================================================
...
translational components: A torque (step) accelerates both the inertia
(of the wheel) and the mass (of the vehicle). Du to a speed dependent
force (like driving resistance), we find an eqilibrium at 5 m/s after
approx. 5 s.
...
![image34](Modelica.Mechanics.Rotational.Examples.FirstI.png) [Modelica.Mechanics.Rotational.Examples](Modelica_Mechanics_Rotational_Examples.html#Modelica.Mechanics.Rotational.Examples).HeatLosses
=====================================================================================================================================================================================================
...
![image35](Modelica.Mechanics.Rotational.Examples.FirstI.png) [Modelica.Mechanics.Rotational.Examples](Modelica_Mechanics_Rotational_Examples.html#Modelica.Mechanics.Rotational.Examples).SimpleGearShift
==========================================================================================================================================================================================================
...
-   At time = 2 s, the brake frees the ring of the planetary, whereas
    the clutch blocks the ring and the sun. Thus we obtain a gearRatio =
    1.
...
[Automatically generated](http://www.3ds.com/) Fri Nov 12 16:30:44 2010.
