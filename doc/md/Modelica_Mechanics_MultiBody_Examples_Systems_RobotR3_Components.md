...
---------------
  ...
  ![image16](Modelica.Mechanics.MultiBody.Examples.Systems. Map path
...
--------
  ...
  [Current](Modelica_SIunits.html#Modelic current   Current of motor [A]
  a.SIunits.Current)                                
...
----------
  ...
  [Time](Modelica_SIunits.html swingTi 0.5    Additional time after
