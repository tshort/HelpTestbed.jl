...
|Modelica.StateGraph.UsersGuide| `Modelica.StateGraph <Modelica_StateGraph.html#Modelica.StateGraph>`_.UsersGuide
-----------------------------------------------------------------------------------------------------------------
...
#. `Overview of
   library <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide.OverView>`_
   gives an overview of the library.
#. `A first
   example <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide.FirstExample>`_
   demonstrates at hand of a first example how to use this library.
#. `An application
   example <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide.ApplicationExample>`_
   demonstrates varies features at hand of the control of a two tank
   system.
#. `Comparison with
   StateGraph2 <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide.ComparisonWithStateGraph2>`_
   compares Modelica.StateGraph with the much improved version
   Modelica\_StateGraph2.
#. `Release
   Notes <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide.ReleaseNotes>`_
...
#. `Literature <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide.Literature>`_
   ...
   library.
#. `Contact <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide.Contact>`_
...
| Name                                                                                                                                                                                     | Description                   |
+==========================================================================================================================================================================================+===============================+
| |image8| `OverView <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide.OverView>`_                                                                                       | Overview of library           |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------+
| |image9| `FirstExample <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide.FirstExample>`_                                                                               | A first example               |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------+
| |image10| `ApplicationExample <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide.ApplicationExample>`_                                                                  | An application example        |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------+
| |image11| `ComparisonWithStateGraph2 <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide.ComparisonWithStateGraph2>`_                                                    | Comparison with StateGraph2   |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------+
| |image12| `ReleaseNotes <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide.ReleaseNotes>`_                                                                              | Release notes                 |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------+
| |image13| `Literature <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide.Literature>`_                                                                                  | Literature                    |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------+
| |image14| `Contact <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide.Contact>`_                                                                                        | Contact                       |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------+

--------------

|image15| `Modelica.StateGraph.UsersGuide <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide>`_.OverView
-------------------------------------------------------------------------------------------------------------------------
...
.. figure:: ../Resources/Images/StateGraph/UsersGuide/StepAndTransition1.png
   :align: center
   :alt: 
...
.. figure:: ../Resources/Images/StateGraph/UsersGuide/StepAndTransition2.png
   :align: center
   :alt: 
...
.. figure:: ../Resources/Images/StateGraph/UsersGuide/StepAndTransition3.png
   :align: center
   :alt: 
...
.. figure:: ../Resources/Images/StateGraph/UsersGuide/StepAndTransition4.png
   :align: center
   :alt: 
...
-  A JGrafchart or a StateChart need to potentially access variables in
   ...
   Therefore, mostly **global variables** are used in the whole network,
   even if the network is structured hierarchically. In StateGraphs this
   is not necessary, since the physical systems outside of a StateGraph
   might access the step or transition state via a hierarchical name.
   This means that **no global variables** are needed, because the local
   variables in the StateGraph are accessed from local variables outside
   of the StateGraph.
-  It is simpler for a user to understand the information that is
   ...
   defined at exactly one place. In the other methodologies, the setting
   and re-setting of the same variable is cluttered within the whole
   network.
...
.. figure:: ../Resources/Images/StateGraph/UsersGuide/Parallel1.png
   :align: center
   :alt: 
...
.. figure:: ../Resources/Images/StateGraph/UsersGuide/Parallel2.png
   :align: center
   :alt: 
...
.. figure:: ../Resources/Images/StateGraph/UsersGuide/Parallel3.png
   :align: center
   :alt: 
...
.. figure:: ../Resources/Images/StateGraph/UsersGuide/CompositeStep1.png
   :align: center
   :alt: 
...
|image16| `Modelica.StateGraph.UsersGuide <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide>`_.FirstExample
-----------------------------------------------------------------------------------------------------------------------------
...
|image17| `Modelica.StateGraph.UsersGuide <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide>`_.ApplicationExample
-----------------------------------------------------------------------------------------------------------------------------------
...
.. figure:: ../Resources/Images/StateGraph/Examples/ControlledTanks1.png
   :align: center
   :alt: 
...
.. figure:: ../Resources/Images/StateGraph/Examples/ControlledTanks2.png
   :align: center
   :alt: 
...
|image18| `Modelica.StateGraph.UsersGuide <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide>`_.ComparisonWithStateGraph2
------------------------------------------------------------------------------------------------------------------------------------------
...
-  **3 Basic Components (Step, Transition, Parallel)**
   ...
   version (e.g., one step and not 4 step components). This is easier to
   understand and more convenient to use. The "Parallel" component is
   both used as "composite step" (so only one branch), as well as
...
-  **Safer state machines**
   ...
   steps, or branching wrongly out of a parallel component). Contrary to
   StateGraph2, in StateGraph1 such wrong graphs do not lead to an error
   but to unexpected simulation results. Still, other desirable
...
-  **Composite, autonomous, synchronized, preempted subgraphs**
   ...
   alternative has the advantage that it is simple to use (not necessary
   to construct a new class and instanciating this class, and easy
   variable access since no new hierarchy is constructed), the second
   alternative has the advantage that it introduces a Modelica hierarchy
   (useful for large subgraphs). In both cases, various options are
   possible, such as

   #. autonomous subgraphs (branches are executed in parallel
      autonomously),
   #. synchronized subgraphs (branches are executed in parallel and are
      synchronized before leaving the subgraph via the outPort),
...
-  **No infinite looping**:
   ...
   StateGraph1, in StateGraph2 every loop must have at least one delayed
   transition. If this is not the case a translation error occurs which
   states that the model contains an algebraic loop between Booleans
   with the name "checkOneDelayedTransitionPerLoop".
   ...
   does not introduce an unsafe construct in the actions associated with
   a StateGraph2 (e.g., "i = pre(i) + 1" in the equation section outside
   of a when-clause will give an event iteration that never stops).
    It is possible to switch off this feature, by setting parameter
   "loopCheck = **false**" in one transition of a loop, instead of using
   a "delayed transition" at this place (in cases where immediate
   transitions are important and the transition conditions are in a form
   that they cannot fire at the same time instant).
...
André, C. (2003):
    ...
    Machine). <http://www.i3s.unice.fr/~map/WEBSPORTS/Documents/2003a2005/SSMsemantics.pdf>`_.
...
Dressler I. (2004):
    ...
    Modelica. <http://www.control.lth.se/documents/2004/5726.pdf>`_.
...
Harel, D. (1987):
    ...
    Systems <http://www.inf.ed.ac.uk/teaching/courses/seoc1/2005_2006/resources/statecharts.pdf>`_.
...
Malmheden M. (2007):
    ...
    Control <http://www.control.lth.se/documents/2007/5808.pdf>`_.
...
Malmheden M., Elmqvist H., Mattsson S.E., Henrisson D., Otter M. (2008):
    ...
    Mode-Automata <http://www.modelica.org/events/modelica2008/Proceedings/sessions/session3a3.pdf>`_.
...
Maraninchi F., Rémond, Y. (2002):
    ...
    of Safe Critical
    Systems <http://www.sciencedirect.com/science?_ob=MImg&_imagekey=B6V17-461XK2H-2-1&_cdi=5667&_user=100058&_pii=S016764230200093X&_origin=search&_coverDate=03%2F31%2F2003&_sk=999539996&view=c&wchp=dGLzVlz-zSkWA&md5=7ef5d0b715e52fa5deec5cca6e0a4d99&ie=/sdarticle.pdf>`_.
Mosterman P., Otter M., Elmqvist H. (1998):
    `Modeling Petri Nets as Local Constraint Equations for Hybrid
    Systems using
    Modelica <http://www.modelica.org/publications/papers/scsc98fp.pdf>`_.
...
Otter M., Malmheden M., Elmqvist H., Mattsson S.E., Johnsson C. (2009):
    ...
    Systems <http://www.modelica.org/events/modelica2009>`_.
...
|image19| `Modelica.StateGraph.UsersGuide <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide>`_.ReleaseNotes
-----------------------------------------------------------------------------------------------------------------------------
...
-  Renamed "MacroStep" to "CompositeStep" and the ports of the MacroStep
   from "abort" to "suspend" and "histoy" to "resume".
...
|image20| `Modelica.StateGraph.UsersGuide <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide>`_.Literature
---------------------------------------------------------------------------------------------------------------------------
...
|image21| `Modelica.StateGraph.UsersGuide <Modelica_StateGraph_UsersGuide.html#Modelica.StateGraph.UsersGuide>`_.Contact
------------------------------------------------------------------------------------------------------------------------
...
.. |Modelica.StateGraph.UsersGuide| image:: Modelica.StateGraph.UsersGuideI.png
.. |Modelica.StateGraph.UsersGuide.OverView| image:: Modelica.StateGraph.UsersGuide.OverViewS.png
.. |Modelica.StateGraph.UsersGuide.FirstExample| image:: Modelica.StateGraph.UsersGuide.OverViewS.png
.. |Modelica.StateGraph.UsersGuide.ApplicationExample| image:: Modelica.StateGraph.UsersGuide.OverViewS.png
.. |Modelica.StateGraph.UsersGuide.ComparisonWithStateGraph2| image:: Modelica.StateGraph.UsersGuide.OverViewS.png
.. |Modelica.StateGraph.UsersGuide.ReleaseNotes| image:: Modelica.StateGraph.UsersGuide.ReleaseNotesS.png
.. |Modelica.StateGraph.UsersGuide.Literature| image:: Modelica.StateGraph.UsersGuide.LiteratureS.png
.. |Modelica.StateGraph.UsersGuide.Contact| image:: Modelica.StateGraph.UsersGuide.ContactS.png
.. |image8| image:: Modelica.StateGraph.UsersGuide.OverViewS.png
.. |image9| image:: Modelica.StateGraph.UsersGuide.OverViewS.png
.. |image10| image:: Modelica.StateGraph.UsersGuide.OverViewS.png
.. |image11| image:: Modelica.StateGraph.UsersGuide.OverViewS.png
.. |image12| image:: Modelica.StateGraph.UsersGuide.ReleaseNotesS.png
.. |image13| image:: Modelica.StateGraph.UsersGuide.LiteratureS.png
.. |image14| image:: Modelica.StateGraph.UsersGuide.ContactS.png
.. |image15| image:: Modelica.StateGraph.UsersGuideI.png
.. |image16| image:: Modelica.StateGraph.UsersGuideI.png
.. |image17| image:: Modelica.StateGraph.UsersGuideI.png
.. |image18| image:: Modelica.StateGraph.UsersGuideI.png
.. |image19| image:: Modelica.StateGraph.UsersGuide.ReleaseNotesI.png
.. |image20| image:: Modelica.StateGraph.UsersGuide.LiteratureI.png
.. |image21| image:: Modelica.StateGraph.UsersGuide.ContactI.png
