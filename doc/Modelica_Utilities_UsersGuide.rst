...
|Modelica.Utilities.UsersGuide| `Modelica.Utilities <Modelica_Utilities.html#Modelica.Utilities>`_.UsersGuide
-------------------------------------------------------------------------------------------------------------
...
#. `Release
   Notes <Modelica_Utilities_UsersGuide.html#Modelica.Utilities.UsersGuide.ReleaseNotes>`_
   summarizes the differences between different versions of this
   library.
#. `ImplementationNotes <Modelica_Utilities_UsersGuide.html#Modelica.Utilities.UsersGuide.ImplementationNotes>`_
   describes design decisions for this library especially for Modelica
   tool vendors.
#. `Contact <Modelica_Utilities_UsersGuide.html#Modelica.Utilities.UsersGuide.Contact>`_
...
| Name                                                                                                                                                                | Description            |
+=====================================================================================================================================================================+========================+
| |image4| `ImplementationNotes <Modelica_Utilities_UsersGuide.html#Modelica.Utilities.UsersGuide.ImplementationNotes>`_                                              | Implementation Notes   |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------+
| |image5| `ReleaseNotes <Modelica_Utilities_UsersGuide.html#Modelica.Utilities.UsersGuide.ReleaseNotes>`_                                                            | Release notes          |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------+
| |image6| `Contact <Modelica_Utilities_UsersGuide.html#Modelica.Utilities.UsersGuide.Contact>`_                                                                      | Contact                |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------+

--------------

|image7| `Modelica.Utilities.UsersGuide <Modelica_Utilities_UsersGuide.html#Modelica.Utilities.UsersGuide>`_.ImplementationNotes
--------------------------------------------------------------------------------------------------------------------------------
...
-  **Character Encoding**
   ...
   of this package can be used independent from the underlying character
   representation.
   ...
   be adapted to the character representation supported in the Modelica
   vendor environment.
-  **Internal String Representation**
    The design of this package was made in order that string handling is
   ...
   efficient (O(1) access instead of O(n) as in standard C). This allows
   to hide string pointer arithmetic from the user. In such a case, a
   similiar efficiency as in C can be expected for most high level
   operations, such as find, sort, replace. The "efficient character
   access" can be reached if, e.g., the number of characters are stored
   in a string, and the length of a character is fixed, say 16 or 32 bit
   (if all Unicode characters shall be represented). A vendor should
   adapt the reference implementation in this respect.
...
|image8| `Modelica.Utilities.UsersGuide <Modelica_Utilities_UsersGuide.html#Modelica.Utilities.UsersGuide>`_.ReleaseNotes
-------------------------------------------------------------------------------------------------------------------------
...
|image9| `Modelica.Utilities.UsersGuide <Modelica_Utilities_UsersGuide.html#Modelica.Utilities.UsersGuide>`_.Contact
--------------------------------------------------------------------------------------------------------------------
...
Dag Brück, Dassault Systèmes AB, Sweden.
 email: `Dag.BRUCK@3ds.com <mailto:Dag.BRUCK@3ds.com>`_
...
.. |Modelica.Utilities.UsersGuide| image:: Modelica.Utilities.UsersGuideI.png
.. |Modelica.Utilities.UsersGuide.ImplementationNotes| image:: Modelica.Utilities.UsersGuide.ImplementationNotesS.png
.. |Modelica.Utilities.UsersGuide.ReleaseNotes| image:: Modelica.Utilities.UsersGuide.ReleaseNotesS.png
.. |Modelica.Utilities.UsersGuide.Contact| image:: Modelica.Utilities.UsersGuide.ContactS.png
.. |image4| image:: Modelica.Utilities.UsersGuide.ImplementationNotesS.png
.. |image5| image:: Modelica.Utilities.UsersGuide.ReleaseNotesS.png
.. |image6| image:: Modelica.Utilities.UsersGuide.ContactS.png
.. |image7| image:: Modelica.Utilities.UsersGuideI.png
.. |image8| image:: Modelica.Utilities.UsersGuide.ReleaseNotesI.png
.. |image9| image:: Modelica.Utilities.UsersGuide.ContactI.png
